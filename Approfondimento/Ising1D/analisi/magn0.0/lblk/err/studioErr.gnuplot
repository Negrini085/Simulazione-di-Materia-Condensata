...
unset ttics
set title "Dimensione blocco: 10000 spin, T = 0.5" 
...
p 'errM_size10000_t0.5.dat' u (($0+1)*20):1 w l lw 2 t 'Traiettoria 1', '' u (($0+1)*20):2 w l lw 2 t 'Traiettoria 2', '' u (($0+1)*20):3 w l lw 2 t 'Traiettoria 3', '' u (($0+1)*20):4 w l lw 2 t 'Traiettoria 4'
#    EOF
