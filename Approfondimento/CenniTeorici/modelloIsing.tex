...
\usepackage{tikz}
\usepackage{tcolorbox}  % Per i riquadri colorati
\usepackage{caption} 
...
\definecolor{blocchi}{RGB}{56, 97, 14}
...
\input{Sezioni/Ising1D.tex}
\newpage
\input{Sezioni/Ising2D.tex}
\newpage
\input{Sezioni/ModelloXY.tex}
\newpage
\input{Sezioni/monteCarlo.tex}
\newpage
\input{Sezioni/simIsing1D.tex}
\newpage
\input{Sezioni/simIsing2D.tex}
\input{Sezioni/simXY.tex}
\newpage
