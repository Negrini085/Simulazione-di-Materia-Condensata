...
!./columninfo.awk screen2.xyz

#set the following initial values for the fit
x0=27.069
y0=30.104
z0=1.0
zmin=5.67504 #zmin corresponds to the bottom atoms of the droplet
r=24.63

h(x,y) = sqrt(r**2 - (x-x0)**2 - (y-y0)**2) + z0

# fit above zmin to exclude the atoms at the interface
fit [x0-r:x0+r][y0-r:y0+r][zmin+3:] h(x,y) "screen2.xyz" u 2:3:4 via x0,y0,z0,r

# check the fit
sp h(x,y), "screen2.xyz" u 2:3:4 w p t 'Surface oxigen'
